...
static void display_usage(){
    printf("aes.exe [OPTION]... input_file output_file key_file\n");
    printf("OPTION\n");
    printf("-1 | -2| -3\t Key length. 1(default):128 2:196 3:256\n");
    printf("modes:\n");
    printf("-e\tECB(default)\n");
    printf("-b\tCBC\n");
    printf("-t\tCTR\n");
    printf("-c | -C\tc:CFB-1 C:CFB-8\n");
    printf("-o | -O\to:OFB-1 O:OFB-8\n");
...
static const uint8_t get_sbox_value(uint8_t num){
    return sbox[num];
}

static const uint8_t get_sbox_invert(uint8_t num){
    return rsbox[num];
}
...
//static void add_round_key(uint8_t round, state_t* state, const uint16_t* round_key);
